...
protocol GovernetsSelectDelegate {
    func onclickselectGovernate(cell:AddNewAddressCell)
    func onclickselectArea(cell:AddNewAddressCell)
}
class AddNewAddressCell: UITableViewCell ,UITextFieldDelegate,UITextViewDelegate {
    ...
    @IBOutlet weak var viewSelectGovernate: UIView!
      var delegate:GovernetsSelectDelegate?
    ...
    @IBOutlet weak var lblRequiredBildingNo: UILabel!
    ...
    func textFieldDidBeginEditing(_ textField: UITextField)  {
        ...
        {
             lblRequiredBildingNo.isHidden = true
